    ...
    try {
      ...
      channel.consume(
        ...
        async (msg) => {
          ...
          console.log(
            `Received message from ${queueName} with routing key ${routingKey}: ${msg.content.toString()}`
          );
        },
        { noAck: true }
      );
...
module.exports = {
  ...
  sendToQueue,
  consumeFromQueue,
  sendMessageToDirectExchange: sendDirectExchange,
  consumeFromDirectExchange: consumeDirectExchange,
};
